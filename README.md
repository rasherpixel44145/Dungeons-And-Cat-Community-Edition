...
# 🎮 Dungeons And Cat — Community Edition

**A cozy dungeon-crawling RPG starring a fearless cat.**
...
Dungeons And Cat is a casual role-playing adventure in which a feline hero explores dungeons, battles monsters, and collects loot across handcrafted levels. This Community Edition is a standalone, self-contained package containing the full game. It runs entirely offline and requires no storefront or additional software.

Players seeking a lightweight, offline RPG experience on Windows without a storefront.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1526540/9901feb3d9c0355cdedae9f08c471900e26cd082/ss_9901feb3d9c0355cdedae9f08c471900e26cd082.1920x1080.jpg?t=1787882652" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1526540/fbb1e9fe8511007a59c9c53db2f51171c436088a/ss_fbb1e9fe8511007a59c9c53db2f51171c436088a.1920x1080.jpg?t=1787882652" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1526540/a99eb6c5e6a973bba8d91606ba1dd1ecf855ae11/ss_a99eb6c5e6a973bba8d91606ba1dd1ecf855ae11.1920x1080.jpg?t=1787882652" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🐱 **Cat Protagonist** — Guide a brave cat hero through monster-filled dungeon depths.
- ⚔️ **Dungeon Crawling** — Explore handcrafted dungeon floors with traps, secrets, and bosses.
- 🎒 **Loot and Gear** — Collect weapons, armor, and items to strengthen your character.
- 📈 **Casual RPG Mechanics** — Accessible leveling and combat suited to short or long sessions.
- 🔌 **Fully Offline** — Play without an internet connection after installation.
- 💾 **Small Footprint** — Lightweight install size that runs on modest hardware.
- 🖱️ **Simple Controls** — Point-and-click friendly interface with keyboard support.
...
| **RAM** | 2 GB | 4 GB |
| **Graphics** | Integrated graphics (Intel HD 4000 or better) | Dedicated GPU with 1 GB VRAM |
| **Storage** | 500 MB available space | 1 GB available space |
| **Additional** | Keyboard and mouse | Keyboard, mouse, and audio output |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\DungeonsAndCat\Saved`
